...
/*   Updated: 2022/07/22 14:24:17 by ncarob           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(Form const &form) {
	if (!form.getSignedStatus())
		std::cout << _name << " cannot execute " << form.getName() << " because the form is yet to be signed" << std::endl;
	else if (form.getToExecGrade() < _grade)
		std::cout << _name << " cannot execute " << form.getName() << " because of the grade difference" << std::endl;
	else {
